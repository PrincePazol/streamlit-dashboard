...
st.link_button('Check my Github 📲', 'https://github.com/PrincePazol/')
...
with cl2:
  with st.expander('Region_ViewData'):
    ...
    st.download_button('Download Data', data=csv, file_name='Region.csv', mime='text/csv', use_container_width=True, help='Click here to download the data as a csv file')
...
st.subheader('Hierarchical view of Sales usning treemap')
...
with st.expander('Summary_Table'):
  ...
  sub_category_Year = pd.pivot_table(filtered_df, values='Sales',
                                     index=['Sub-Category'],
                                     columns='month')
...
data1['layout'].update(title='Relationship bewteen Sales and Profits using Scatter Plot',
